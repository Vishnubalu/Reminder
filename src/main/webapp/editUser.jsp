	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body mx-3">
				<form action="editUser" method="post" onclick="return validate()">
				
					<label for="userName">UserName</label> <input type="text" id="userName"
						name="userName" value="<%=user.getName() %>"> <input
						type="hidden" name="userId" value=<%=user.getName() %>> <label
						for="mobileNumber">MobileNumber</label> <input type="text"
						id="mobileNumber" name="mobileNumber"
						value=<%=user.getMobileNum() %>> <label for="email">Email</label>
