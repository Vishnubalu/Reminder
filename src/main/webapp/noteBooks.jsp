...
<body>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body mx-3">
						<form action="/project/notebooks" name="myForm" value ="ADD"
						    ...
						    <input type="submit" value="addNoteBook" id="submit" name="ACTION">
						</form>
					</div>
	...
	<%int i=0;%>
		...
		<c:forEach items="<%=books %>" var="noteBook">
		<% i=i+1; %>
			<tr>
				<td>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-2 text-center"><b>
										<a  href="notecontroller?nid=${noteBook.getBookId()}&name=${noteBook.getBookName()}"><c:out value="${noteBook.getBookName()}" />
										</a></b>
										<div>
									      <c:out value="${noteBook.getCount()} Notes "/>
									   </div>
									</div>
									<div class="col-md-8 text-right">
										<a id="editNoteBook" href="editNoteBook.jsp?Id=${noteBook.getBookId()}&bookName= '${noteBook.getBookName()}'"><span
											class="glyphicon glyphicon-edit">Edit</span></a>
											
									</div>
									<div>
									<%NoteBooks notebook = new NoteBooks();
									notebook = (NoteBooks)books.get(i-1);
									if(notebook.getCount() <= 0) { %><a id="deleteNoteBook"  href="notebooks?bookId= ${noteBook.getBookId()}"><span
